$clear @s $(item_5)[!minecraft:custom_name,!minecraft:custom_data] $(count_5)
$data modify storage nc:player players[$(p_id)].daily.complete_5 set value 1
$data modify storage nc:player players[$(p_id)].daily.item_5 set value "minecraft:lime_stained_glass_pane"
$data modify storage nc:player players[$(p_id)].daily.count_5 set value 1

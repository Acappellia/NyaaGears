...
data modify storage ng:lotto_gem items[-1].tag.Enchantments set from storage ng:lotto_gem items[-1].tag.StoredEnchantments
...
data remove storage ng:lotto_gem items[-1].tag.StoredEnchantments

$clear @s $(item_1)[!minecraft:custom_name] $(count_1)
$data modify storage ng:player players[$(p_id)].daily.complete_1 set value 1
$data modify storage ng:player players[$(p_id)].daily.item_1 set value "minecraft:lime_stained_glass_pane"
$data modify storage ng:player players[$(p_id)].daily.count_1 set value 1

...
execute if score #daily_checkcount ng >= #daily_reqcount ng run function ng:daily/checks/item_3_takeall with storage ng:tmp p_daily
execute unless score #daily_checkcount ng >= #daily_reqcount ng run function ng:daily/checks/item_3_takepart with storage ng:tmp p_daily

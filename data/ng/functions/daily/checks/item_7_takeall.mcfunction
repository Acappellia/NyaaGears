...
$data modify storage ng:player players[$(p_id)].daily.complete_7 set value 1
$data modify storage ng:player players[$(p_id)].daily.item_7 set value "minecraft:lime_stained_glass_pane"
$data modify storage ng:player players[$(p_id)].daily.count_7 set value 1

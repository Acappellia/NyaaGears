...
data modify storage ng:tmp offhand.components."minecraft:attribute_modifiers".modifiers[-1].uuid set from entity @e[type=area_effect_cloud,distance=..1,limit=1,tag=ng_uuid] UUID

...
execute store result storage ng:tmp offhand.components."minecraft:enchantments".levels."minecraft:looting" int 1 run scoreboard players operation #ench_lvl_origin ng += #ench_lvl_update ng
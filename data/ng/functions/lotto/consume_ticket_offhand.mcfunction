...
execute store result score @s ng_lottotype run data get storage ng:tmp offhand.components."minecraft:custom_data".ng_lotto_type
execute store result score @s ng_lottocount run data get storage ng:tmp offhand.count
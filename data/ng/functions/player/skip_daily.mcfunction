...
execute if score @s ng_daily_remain matches ..0 run tellraw @s [{"text": "[","color": "white"},{"text": "NyaaGears","color": "green"},{"text": "] ","color": "white"},{"text": " 使用失败…… 所有收集表都已完成","color": "gray"}]
execute if score @s ng_daily_remain matches ..0 run return -1

tellraw @s [{"text": "[","color": "white"},{"text": "NyaaGears","color": "green"},{"text": "] ","color": "white"},{"text": " 已跳过当前的收集表","color": "#66ffcc"}]

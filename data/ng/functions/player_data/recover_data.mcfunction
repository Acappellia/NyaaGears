...
execute store result score @s p_id run data get storage ng:player uuid_check[0].playerid
function ng:player_data/recover_scoreboard with storage ng:player uuid_check[0]
